...
| E2E checks (files named `*.e2e.test.ts`)                                       | **No**                  | Per testing-strategy.md, an E2E check drives a separately running system over its own protocol channel, never a vendor network.                                                                                                                                                                                                                                                                                                  |
