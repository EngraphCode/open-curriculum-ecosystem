...
| E2E checks (today `*.e2e.test.ts` files, a pre-invariant name)                 | **No**                  | Per testing-strategy.md, an E2E check drives a separately running system over its own protocol channel, never a vendor network.                                                                                                                                                                                                                                                                                                  |
