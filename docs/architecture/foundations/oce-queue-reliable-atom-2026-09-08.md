...
The source-inspection basis includes the Reliable Atoms programme (the strategic plan node the owner ratified on 2026-09-08; its decision is recorded in [ADR-229](../architectural-decisions/229-own-built-algorithm-and-data-structure-foundations.md)), principles, metacognition, reason and proportionality at inspected engraph SHA `270b8ec6fb82dc6881c10ca101cb8d3c7a242d6e`. This is a read-only design basis, not repository-wide conformance or implementation authorisation.
