...
description: >-
  ...
  be drifting; returns a work verdict (ON-TRACK, DRIFTING or WRONG-PRIORITY) and a mechanically
  derived frame verdict (SOUND, NARROWED or CONTRADICTED), with one redirection.
readonly: true
---
