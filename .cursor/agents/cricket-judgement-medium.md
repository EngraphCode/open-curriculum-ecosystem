...
description: >-
  ...
  proportion, or a wait/gate may be drifting; returns a work verdict (ON-TRACK, DRIFTING or
  WRONG-PRIORITY) and a frame verdict (SOUND, NARROWED or CONTRADICTED), with evidence and one
  redirection.
readonly: true
---
