...
3. Report two kinds of finding, kept apart: **ordering breaks against Oak's threads** (a unit placed before one that comes earlier in Oak's curriculum order for that subject, whether an earlier year or the same year — data), and **assumed knowledge the plan may not have taught yet** (a stated requirement with no earlier unit that plausibly covers it — the agent's judgement).
