 ...
 * every fixture — so an edit to one without the other red-gates.
 */
...
writeLine(
  `✓ operator-profile contract ${String(version)} and the family-${OPERATOR_PROFILE_SCHEMA_VERSION} enforcement schema agree on ${checked} fixtures`,
);
