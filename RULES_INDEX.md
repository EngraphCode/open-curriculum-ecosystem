...
| `.agent/rules/pre-merge-divergence-analysis.md`                            | situational    | ceremony:merge — every merge: the premise sweep at any size; the full workflow past the thresholds |
