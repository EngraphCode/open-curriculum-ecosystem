...
once the parent has landed, merge the default branch into the child or re-cut it before
any check against the default branch (a squash-landed parent's commits are not ancestors).
