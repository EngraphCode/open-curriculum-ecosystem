...
| Model-authored text crosses a trust boundary only through a harness-owned closed grammar (candidate principle; Swallow holds Drift's concept exploration, 2026-09-26; two instances in one session, in different registers: B0 read a code-mode program's printed output as evidence, and PR 241's exec-policy prefix allows admitted a model-typed argument tail to host authority) | By review, the landing toolkit's wrappers and B0's reader both hold under review, and a third boundary instance has been found and cured the same way | A boundary where admitting unparsed model-authored text is correct and safe, or the wrappers need argument pass-through to be useful | 2026-10-10 |
| PDR-075 Director substrate-writing discipline — promote or retire the Candidate record (Candidate since 2026-05-23; the 2026-05-24 §Status Review kept it Candidate) | By review: a fourth worked instance in a session distinct from 2026-05-23, recorded under §Worked Instances, or owner ratification | Neither by review — retire the PDR, recorded in its status line | 2026-10-01 (first consolidation on/after) |
