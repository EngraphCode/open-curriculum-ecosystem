...
- **Focused local-startup follow-up** (active record; all phases completed, packaged in
  ...
  (completed; in `plans-old-archive`, observability archive)
...
- **PR #87 unblock** (next-session pickup):
  `pr-87-quality-finding-resolution.plan.md`
  (superseded; in `plans-old-archive`, observability superseded archive)
