...
- **#87 (R) LANDED 2026-09-08 13:5xZ as the bot — merge SHA:143dc6961 on engraph, final head SHA:c072b120f
  ...
  inventory, the provenance line and ADR-231 all homed in PR N. Train next: N → H → A → B → C.
- **PR #88 (N) open 2026-09-08 14:0xZ (Altair 05a180), head SHA:a742cd850 from worktree proven-paths-n,
  ...
  hygiene §1, the trigger paragraph, the lane-cut skill and residency clause 8; ADR-231
...
- **Pointer (s), from #88's review (Altair 05a180):** extending.md requires every canonical rule to open
  ...
  → ADR-231 among them) and land the scanner the governance-claim pattern asks for, one PR each.
...
- **The window (13:1xZ → 15:1xZ).** #87 landed (SHA:143dc6961: pr-target-is-engraph retired; the general
  ...
  grant; hygiene §6 with the ignored inventory; the build-ahead family on five surfaces; ADR-231
...
- **Metaloss.** Pass one: the record's #88 round lines carry the tally and the declared exit; the
  two PR C pointers stand (the identity plan's citation of ADR-231; the branch-rule alias was
...
- **The window (17:1xZ → 19:1xZ).** #89's second round (seven Codex findings, all case-list gaps
  ...
  undrafted (the 8 September curriculum delta), #92 (own-built foundations, ADR-230), #94 new.
...
- §6, a re-truing narrows to the claim the change refuted, never wider: #92's reconciliation
  ...
  principles.md when ADR-230 altered one class; the premise sweep's over-reach shape, to be
